...
const [slidNextBtn, setSlidNextBtn] = React.useState(true);
  ...
  return (
    <>
     <div className="relative  pl-4 pr-4 sm:pl-7 sm:pr-7 xl:pr-[100px] mt-5 mb-2 z-[99] py-5 gap-[20px] lg:gap-[170px] mx-auto max-w-[1350px] flex items-center justify-between flex-col lg:flex-row text-white">
         <div>
     ...
     <div className="flex lg:hidden items-center justify-center gap-5 pl-4 pr-4  z-[99] py-3 mx-auto max-w-[1350px]">
